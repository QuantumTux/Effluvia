...
If you read the various SFB tactical wisdom (published in various _Captain's Log_ magazines, and add-ons such as the _Tactics Manual_), it's pointed out that tractor beams are frequently under-utilized systems. I decided to write an SFB training scenario that emphasized using tactors, and explicitly avoided being a combat scenario. If you're tired of two ships bashing each other, this is a welcome change of pace.
