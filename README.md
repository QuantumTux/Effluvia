...
# StarFleetBattles
A sub-directory for files related to [Star Fleet Battles](https://en.wikipedia.org/wiki/Star_Fleet_Battles).

## TheCultOfRobust.pdf
My thoughts on lessons for IT security professionals to take from the [UK Post Office Horizon IT scandal](https://en.wikipedia.org/wiki/British_Post_Office_scandal).
